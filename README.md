# Watermark Project# Watermark Project



Проект для встраивания и извлечения водяных знаков в изображения с использованием стеганографических методов LSB (Least Significant Bit).# Watermark Project



## ВозможностиПроект для встраивания и извлечения водяных знаков в изображения с использованием стеганографических методов LSB (Least Significant Bit).



- **Встраивание водяных знаков**: поддержка текстовых и изображениевых секретовПроект для встраивания и извлечения водяных знаков в изображения с использованием стеганографических методов LSB (Least Significant Bit).

- **Извлечение водяных знаков**: восстановление скрытой информации из стегоизображений

- **Графический интерфейс**: удобный GUI на PyQt5 с предпросмотром## Возможности

- **Консольный режим**: CLI для автоматизации и тестирования

- **Поддержка форматов**: PNG, JPG, BMP для изображений, TXT для текста## Возможности

- **Интерактивные превью**: клик по превью для открытия текстовых файлов

- **Сборка exe**: создание standalone исполняемого файла- **Встраивание водяных знаков**: поддержка текстовых и изображениевых секретов

- **Модульная архитектура**: легкое расширение новыми алгоритмами

- **Извлечение водяных знаков**: восстановление скрытой информации из стегоизображений- **Встраивание водяных знаков**: поддержка текстовых и изображениевых секретов

## Структура проекта

- **Графический интерфейс**: удобный GUI на PyQt5 с предпросмотром- **Извлечение водяных знаков**: восстановление скрытой информации из стегоизображений

```

watermark_project/- **Консольный режим**: CLI для автоматизации и тестирования- **Графический интерфейс**: удобный GUI на PyQt5 с предпросмотром
...
## Установка и запуск watermark_project/watermark_project/



### Требования├── main.py                    # Точка входа в приложение├── main.py                    # Точка входа в приложение



- Python 3.7+├── gui/                       # Графический интерфейс├── gui/                       # Графический интерфейс

- PyQt5

- Pillow (PIL)│   ├── window.py             # Главное окно приложения│   ├── window.py             # Главное окно приложения

- NumPy

- Matplotlib│   ├── layout.py             # Компоновка элементов интерфейса│   ├── layout.py             # Компоновка элементов интерфейса



### Установка зависимостей│   └── events.py             # Обработчики событий и логика│   └── events.py             # Обработчики событий и логика



```bash├── watermark/                 # Основные алгоритмы стеганографии├── watermark/                 # Основные алгоритмы стеганографии

pip install -r requirements.txt

```│   ├── embedding.py          # Алгоритмы встраивания│   ├── embedding.py          # Алгоритмы встраивания



Или вручную:│   ├── extraction.py         # Алгоритмы извлечения│   ├── extraction.py         # Алгоритмы извлечения

```bash

pip install PyQt5 Pillow numpy matplotlib│   ├── utils.py              # Вспомогательные функции│   ├── utils.py              # Вспомогательные функции

```

│   └── algorithms/           # Модули алгоритмов│   └── algorithms/           # Модули алгоритмов

### Запуск приложения

│       └── lsb/             # LSB алгоритмы│       └── lsb/             # LSB алгоритмы

**Графический интерфейс (по умолчанию):**

```bash└── tests/                     # Тесты└── tests/                     # Тесты

python main.py

```    ├── unit_tests/           # Модульные тесты    ├── unit_tests/           # Модульные тесты



**Консольный режим:**    ├── integration_tests/    # Интеграционные тесты    ├── integration_tests/    # Интеграционные тесты

```bash

python main.py --cli    └── test_data/           # Тестовые данные    └── test_data/           # Тестовые данные
